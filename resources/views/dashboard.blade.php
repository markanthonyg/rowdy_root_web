...
<head>
  ...
  <meta charset="utf-8">
  <title>EMRS Online | Dashboard</title>
    ...
    <header class="navbar navbar-fixed-top navbar-shadow">
      ...
      <ul class="nav navbar-nav navbar-left">
        <li class="dropdown menu-merge hidden-xs">
          <a href="#" class="dropdown-toggle hidden" data-toggle="dropdown" role="button" aria-expanded="false">Dropdown
      ...
      <ul class="nav navbar-nav navbar-right">
				<li>
					<div class="navbar-btn btn-group hidden">
        ...
        <li class="menu-divider hidden-xs hidden">
        ...
        <li class="dropdown menu-merge">
          ...
          <ul class="dropdown-menu list-group dropdown-persist w250" role="menu">
            <li class="dropdown-header clearfix">
              <div class="pull-left ml10 hidden">
              ...
              <div class="pull-right mr10 hidden">
                <select id="user-role">
    ...
    <aside id="sidebar_left" class="nano nano-light affix">
      ...
      <div class="sidebar-left-content nano-content">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <div class="media-links">
                   <a href="#" class="sidebar-menu-toggle hidden">User Menu -</a> <a href="pages_login(alt).html">Logout</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- End: Sidebar Menu -->
	      ...
	      <div class="sidebar-toggle-mini hidden">
	        <a href="#">
            ...
            <div class="col-sm-4 col-xl-3">
              <div class="panel panel-tile text-center br-a br-grey">
                <div class="panel-body">
                  ...
                  <h6 class="text-warning">PATIENTS</h6>
                </div>
                <div class="panel-footer br-t p12">
                  <span class="fs11">
            ...
            <div class="col-sm-3 col-xl-3 visible-xl">
              <div class="panel panel-tile text-center br-a br-grey">
                <div class="panel-body">
                  ...
                  <h6 class="text-danger">VISITS</h6>
                </div>
                <div class="panel-footer br-t p12">
                  <span class="fs11">
